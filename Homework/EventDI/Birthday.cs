...
namespace EventDI
{
    public class Birthday : EventInfo, ICost, IGuest
    {
        //Fields
        List<string> guestList = new List<string>();
        //Constructor
        public Birthday(int Id, string Desc, double Cost) : base(Id, Desc, Cost)
        {
        }
        //Methods
        ...
        {
            string pntStr = "";
            Console.WriteLine("Birthday Guest List:");
        ...
        {
            return ("Birthday - ID: " + this.Id + ", Desc: " + this.Desc + ", Cost: " + this.Cost);
        }
    }
}